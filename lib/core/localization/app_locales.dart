...
/// The app's ARB-based delegate plus material_ui's bundled Material,
/// Cupertino, and Widgets delegates.
///
/// `AppLocalizations.localizationsDelegates` (generated by `flutter
/// gen-l10n`) still wires the legacy `flutter_localizations` trio, whose
/// `MaterialLocalizations`/`CupertinoLocalizations` types are distinct from
/// the ones `package:material_ui`/`package:cupertino_ui` widgets look up
/// since Flutter 3.47 decoupled those design packages from the core SDK. Use
/// this list instead everywhere an app widget needs
